  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-md border-b border-cream/50 px-6 py-4 flex justify-between items-center transition-all">
        ...
        <a href="https://wa.me/6281222206992" className="bg-mustard text-white px-8 py-3 rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-brown transition-all shadow-soft active:scale-95">
          Hubungi Kami
        </a>
      </nav>
